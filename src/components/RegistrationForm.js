...
const RegistrationForm = ({ notify }) => {
  ...
  return (
    <div className="container-fluid" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh',marginTop:'-40px',  }}>
      <div className="formbox">
        ...
        />
          ...
          <Form.Item
          label={<label style={{ color: "white", padding : '5px', paddingRight:'18px' }}>Username  </label>}
            name="myName"         
          ...
          <Form.Item
            label={<label style={{ color: "white", padding : '5px', paddingRight:'25px' }}>Army ID  </label>}
            name="myArmyId"
            style={{ color: 'blue' }}
          ...
          <Form.Item
            label={<label style={{ color: "white", padding : '5px' }}>Batch Number  </label>}
            name="myBatchNo"
            rules={[
          ...
          <Form.Item
            label={<label style={{ color: "white", padding : '5px', paddingRight:'20px' }}>Password  </label>}
            name="mySetPassword"
